...
Most skills in this repository are original work by [@Pluvio9yte](https://x.com/Pluvio9yte).

The following skills are adapted from or inspired by external open-source projects. Their original licenses and attribution are preserved inside each skill directory.

## External Skills

| Skill | Original Author | Source | License |
|-------|----------------|--------|---------|
| `dbs` + all `dbs-*` (22 skills) | [@dontbesilent](https://x.com/dontbesilent) | [dbskill](https://github.com/dontbesilent2025/dbskill) | CC BY-NC 4.0 |
